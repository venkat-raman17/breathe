/**
 * Shared non-medical disclaimer content (used by the onboarding step and the Settings modal).
 * Title is provided by the host screen.
 */
  ...
  return (
    <View>
      ...
      <AppText variant="body" color="lo" style={{ marginTop: spacing.xs }}>
        ...
        other energy models are how a tradition describes inner experience, not measured anatomy. Where
        a popular idea is actually a modern synthesis (such as the rainbow-chakra colors), we say so.
      </AppText>
